        ...
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-xl shadow-xl">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">{rating}</span>
                </div>
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900">${price}</span>
                    <button className="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={onClick}>
                        Saiba mais
                    </button>
                </div>
            </div>
